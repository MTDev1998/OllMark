...
public class IntentRouterService implements ToolRouterPort {
    ...
    private static final String ROUTER_SYSTEM_PROMPT = """
        ...
        - CONTENT_AND_TEXT  : text, title, paragraph, subtitle, marketing text
        - SHAPE_CREATION    : create rectangle, board, frame, section container
        - LAYOUT_AND_ALIGNMENT : align, arrange, layout structure
        ...
        Response: {"categories": ["TEMPLATE_SEARCH", "SHAPE_CREATION", "CONTENT_AND_TEXT"]}

        User: "donne moi un poste instagrame ou c'est ecris tarek"
        Response: {"categories": ["SHAPE_CREATION", "CONTENT_AND_TEXT", "LAYOUT_AND_ALIGNMENT"]}

        User: "delete the header"
        Response: {"categories": ["DELETION", "INSPECTION"]}

        User: "create a marketing hero section"
        Response: {"categories": ["SHAPE_CREATION", "CONTENT_AND_TEXT"]}

        Return ONLY JSON. NEVER say "I don't know". If unsure, use SHAPE_CREATION. No explanation. No markdown.
    """;
